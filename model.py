...
# RESHAPING THE Image matrix from dims(nx,nx,3) to dims(nx*nx*3, 1)
...
# FINAL MODEL TO MAKE USE OF ABOVE FUNCTIONS
...
# TESTING ON VARIABLE LEARNING RATES
